		...
		Para j<-0 Hasta 6 Hacer
			...
			Si j<>0 y i<>0 Entonces
				Si i=1 y j<>6 Entonces
					Escribir "Ingrese cuanto se vendio el producto 1 durante la semana el dia: " matriz(0,j)
					Leer matriz(1,j)
				FinSi
				Si i=2 y j<>6 Entonces
					Escribir "Ingrese cuanto se vendio el producto 2 durante la semana el dia: " matriz(0,j)
					Leer matriz(2,j)
				FinSi
				Si i=3 y j<>6 Entonces
					Escribir "Ingrese cuanto se vendio el producto 3 durante la semana el dia: " matriz(0,j)
					Leer matriz(3,j)
				FinSi
				Si i=4 y j<>6 Entonces
					Escribir "Ingrese cuanto se vendio el producto 4 durante la semana el dia: " matriz(0,j)
					Leer matriz(4,j)
				FinSi
				Si i=5 y j<>6 Entonces
					Escribir "Ingrese cuanto se vendio el producto 5 durante la semana el dia: " matriz(0,j)
					Leer matriz(5,j)
				FinSi
			FinSi
		FinPara
